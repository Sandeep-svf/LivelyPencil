...
import com.webnmobapps.livelyPencil.Activity.Setting.RadioChannelSettingsActivity;
...
public class RadioChannelSettingsWizardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_radio_channel_settings_wizard);
        ...
        Indicator = findViewById(R.id.circle_idicatoir_R);
        ...
        radio_save_change_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* Intent intent = new Intent(RadioChannelSettingsWizardActivity.this, PrivacySettingWizardActivity.class);
        ...
        radio_logo_edit_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final LayoutInflater inflater = RadioChannelSettingsWizardActivity.this.getLayoutInflater();
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(RadioChannelSettingsWizardActivity.this);
    ...
    private void profile_camera_open() {
        ...
        boolean readExternal = Permission.checkPermissionReadExternal(RadioChannelSettingsWizardActivity.this);
        boolean writeExternal = Permission.checkPermissionReadExternal2(RadioChannelSettingsWizardActivity.this);
        boolean camera = Permission.checkPermissionCamera(RadioChannelSettingsWizardActivity.this);

        if (camera && writeExternal && readExternal ) {
            if (packageManager.hasSystemFeature(PackageManager.FEATURE_CAMERA)) {

                Intent intent = new Intent(RadioChannelSettingsWizardActivity.this, ImagePickerActivity.class);
            ...
            Toast.makeText(RadioChannelSettingsWizardActivity.this, "camera permission required", Toast.LENGTH_LONG).show();
    ...
    private void edit_radio_setting_api() {
        ...
        final ProgressDialog pd = new ProgressDialog(RadioChannelSettingsWizardActivity.this);
        ...
        {
            Toast.makeText(RadioChannelSettingsWizardActivity.this, "Logo Image Found", Toast.LENGTH_SHORT).show();
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True")) {
                            ...
                            Intent intent = new Intent(RadioChannelSettingsWizardActivity.this, ThankYouWizardActivity.class);
                            startActivity(intent);
    ...
    private boolean validation() {
        ...
        {
            //Toast.makeText(RadioChannelSettingsWizardActivity.this, "Please enter radio tag", Toast.LENGTH_SHORT).show();
            alert_dialog_message("1");
            return  false;
        }else if(topicData.equals("")){
            alert_dialog_message("2");
            return  false;
        }else if(age_group_data.equals(""))
        {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True")) {
                            ...
                            Log.e("tv_logo",": "+temp);
                            Glide.with(RadioChannelSettingsWizardActivity.this).load(temp).placeholder(R.drawable.ic_launcher_background).into(radio_logo_image);
                            Glide.with(RadioChannelSettingsWizardActivity.this).load(BASE_LOGO_IMAGE+radioSettingsResultList.get(0).getRadiocover()).placeholder(R.drawable.ic_launcher_background).into(radio_cover_image);
    ...
    private void alert_dialog_message(String value) {
        ...
        {
            error_message.setText(getResources().getString(R.string.please_enter_tag));
        }else if(value.equals("2"))
        {
            error_message.setText(getResources().getString(R.string.please_enter_topic));
        }else if(value.equals("3"))
        {
            error_message.setText(getResources().getString(R.string.please_enter_age_group));
        }
    ...
    private void intis() {
        nextButton = findViewById(R.id.radio_wizard_next_button);

        radio_age_group_spin = findViewById(R.id.radio_age_group_spin_R);
        radio_topic_spin = findViewById(R.id.radio_topic_spin_R);
        radio_other_tag = findViewById(R.id.radio_other_tag_R);
        radio_logo_edit_layout = findViewById(R.id.radio_logo_edit_layout_R);
        radio_logo_image = findViewById(R.id.radio_logo_image_R);
        radio_cover_edit_layout = findViewById(R.id.radio_cover_edit_layout_R);
        radio_save_change_button = findViewById(R.id.save_change_button_R);
        radio_cover_image = findViewById(R.id.radio_cover_image_R);
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                try {
                    ...
                    if(imageKey.equals("1"))
                    {
                        ...
                        Glide.with(RadioChannelSettingsWizardActivity.this).
