package com.webnmobapps.livelyPencil.Activity;
...
public class SplashActivity extends AppCompatActivity {
   ...
   AppCompatImageView splash_image, chooing_language_image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(SplashActivity.this).load(R.drawable.logo_svg).into(splash_image);
       // Glide.with(SplashActivity.this).load(R.drawable.detect_location).into(chooing_language_image);
