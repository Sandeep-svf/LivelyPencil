...
import com.webnmobapps.livelyPencil.Activity.SplashActivity;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    ConstraintLayout welcome_activity;
    private static final int REQUEST_CODE_ASK_MULTIPLE_PERMISSIONS = 124;
    final List<String> permissionsList = new ArrayList<String>();
    private  String UserID , authorization;
    AppCompatImageView splash_image, chooing_language_image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        welcome_activity = findViewById(R.id.welcome_activity);
        splash_image = findViewById(R.id.splash_image);
        chooing_language_image = findViewById(R.id.chooing_language_image);


        Glide.with(WelcomeActivity.this).load(R.drawable.logo_svg).into(splash_image);
        Glide.with(WelcomeActivity.this).load(R.drawable.detect_location).into(chooing_language_image);
        //Glide.with(SplashActivity.this).load(R.drawable.splash_background).into(splashscreen2);
    ...
    private void internetStatusCheck() {
        Log.e("CHECK","A");
        ConnectivityManager connectivityManager = (ConnectivityManager) WelcomeActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            if (connectivityManager.getActiveNetworkInfo().isConnected()) {
                ...
                //showNetworkSnackBar();
                Intent intent = new Intent(WelcomeActivity.this, InternetErrorActivity.class);
    ...
    private void showNetworkSnackBar() {
        ...
        Snackbar snackbar = Snackbar.make(welcome_activity, "Please Connect Internet Connection  ?", Snackbar.LENGTH_INDEFINITE)
                .setAction("RETRY", new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        WelcomeActivity.this.internetStatusCheck();
                    }
                });
