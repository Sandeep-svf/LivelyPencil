...
public class TvChannelSettingsWizardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tv_channel_settings_wizard);
        ...
        Indicator = findViewById(R.id.circle_idicatoir_tv);
        ...
        tv_cover_edit_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final LayoutInflater inflater = TvChannelSettingsWizardActivity.this.getLayoutInflater();
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(TvChannelSettingsWizardActivity.this);
    ...
    private void profile_camera_open() {
        ...
        boolean readExternal = Permission.checkPermissionReadExternal(TvChannelSettingsWizardActivity.this);
        boolean writeExternal = Permission.checkPermissionReadExternal2(TvChannelSettingsWizardActivity.this);
        boolean camera = Permission.checkPermissionCamera(TvChannelSettingsWizardActivity.this);
        ...
        if (camera && writeExternal && readExternal ) {
            if (packageManager.hasSystemFeature(PackageManager.FEATURE_CAMERA)) {
              /*  values7 = new ContentValues();
                ...
                Intent intent = new Intent(TvChannelSettingsWizardActivity.this, ImagePickerActivity.class);
            ...
            Toast.makeText(TvChannelSettingsWizardActivity.this, "camera permission required", Toast.LENGTH_LONG).show();
    ...
    private void edit_tv_settings_api() {
        ...
        final ProgressDialog pd = new ProgressDialog(TvChannelSettingsWizardActivity.this);
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True")) {
                            ...
                            Intent intent = new Intent(TvChannelSettingsWizardActivity.this, RadioChannelSettingsWizardActivity.class);
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True")) {
                            ...
                            Log.e("tv_logo",": "+temp);
                            Glide.with(TvChannelSettingsWizardActivity.this).load(temp).placeholder(R.drawable.ic_launcher_background).into(tv_logo_image);
                            Glide.with(TvChannelSettingsWizardActivity.this).load(BASE_LOGO_IMAGE+tvSettingsResultList.get(0).getTvcover()).placeholder(R.drawable.ic_launcher_background).into(tv_cover_image);
    ...
    private void alert_dialog_message(String value) {
        ...
        {
            error_message.setText(R.string.please_enter_tag);
        }else if(value.equals("2"))
        {
            error_message.setText(R.string.please_enter_topic);
        }else if(value.equals("3"))
        {
            error_message.setText(R.string.please_enter_age_group);
        }else if(value.equals("back"))
        {
            error_message.setText(R.string.on_back_pressed);
        }
        ...
        close_dialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Intent intent = new Intent(TvChannelSettingsWizardActivity.this, HomeActivity.class);
                    startActivity(intent);
                }
                dialogs.dismiss();
            }
    ...
    private void intis() {
        tv_save_change_button = findViewById(R.id.personal_info_save_change_button_TV);
        tv_cover_edit_layout = findViewById(R.id.tv_cover_edit_layout_TV);
        tv_logo_edit_layout = findViewById(R.id.tv_logo_edit_layout_TV);
        tv_logo_image = findViewById(R.id.tv_logo_image_TV);
        tv_cover_image = findViewById(R.id.tv_cover_image_TV);
        tag_edit_text = findViewById(R.id.tag_edit_text_TV);
        topic_spin = findViewById(R.id.topic_spin_TV);
        age_group_spin = findViewById(R.id.age_group_spin_TV);
    }
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                try {
                    ...
                    if(imageKey.equals("1"))
                    {
                        ...
                        Glide.with(TvChannelSettingsWizardActivity.this).
