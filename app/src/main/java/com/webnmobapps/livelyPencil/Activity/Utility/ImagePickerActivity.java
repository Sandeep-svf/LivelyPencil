...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.design_default_color_primary));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.design_default_color_primary));
